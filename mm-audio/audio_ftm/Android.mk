ifneq ($(MM_AUDIO_FTM_DISABLED),true)
LOCAL_PATH:= $(call my-dir)

include $(CLEAR_VARS)

ifeq ($(call is-board-platform-in-list,msm8960 msm8974 msm8226 msm8610 apq8084),true)
...
mm-audio-ftm-inc += $(KERNEL_DIR)/include
mm-audio-ftm-inc += $(KERNEL_DIR)/include/linux
mm-audio-ftm-inc += $(KERNEL_DIR)/arch/arm/include
...
endif # ifneq ($(MM_AUDIO_FTM_DISABLED),true)
# ---------------------------------------------------------------------------------
#                                       END
# ---------------------------------------------------------------------------------
